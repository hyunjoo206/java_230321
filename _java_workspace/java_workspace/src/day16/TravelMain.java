...
public class TravelMain {
	...
	public static void main(String[] args) {
		...
		*/
		...
		list.stream().forEach(a->System.out.println("이름:"+a.getName()+", 나이:"+a.getAge()+", 비용:"+a.getPrice()));
		System.out.println("--------------------------");
		...
		System.out.println("-----20세 이상 성인만 출력-----");
		list.stream().filter(a-> a.getAge()>=20).map(a->a.getName()).sorted().forEach(System.out::println);
