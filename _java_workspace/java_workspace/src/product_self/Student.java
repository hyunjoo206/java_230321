...
public class Student {
	/*
	 * 학생클래스 : 한 학생의 정보를 나타내는 클래스 - 학번, 이름, 주민번호, 학부, 학과, 수강과목(과목클래스를 배열로 생성) -
	 * 수강과목의 번지를 대신할 subCount - 메서드 - 수강과목 추가 (배열이 다 찼다면 늘려주기) - 수강과목 삭제 - 생성자,
	 * getter/setter, 출력메서드(print) - 학생정보 출력되는 메서드 1개, 학생수강정보 출력되는 메서드 1개
	 */
	...
	private Subject[] subjectList = new Subject[5]; // 수강과목 배열
